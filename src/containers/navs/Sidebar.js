...
import menuItemsMerchant from '../../constants/menu-merchant';
import menuItemsConsumer from '../../constants/menu-consumer';
import menuItemsAdmin from '../../constants/menu-admin';
                    ...
                    >
                      {item.subs &&
                        item.subs.map((sub, index) => {
                          if (
                            sub.to === '/app/profile/activate' &&
                            this.props.user.role === 'Merchant' &&
                            this.props.user.user_object &&
                            this.props.user.user_object.plan.plan.name !==
                              'Free'
                          )
                            return <></>;
                          if (
                            sub.to === '/app/profile/plan' &&
                            this.props.user.role === 'Merchant' &&
                            this.props.user.user_object &&
                            this.props.user.user_object.plan.plan.name ===
                              'Free'
